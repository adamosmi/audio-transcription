...
# file paths
AUDIO_FP = os.path.join('data', 'external', 'youtube', '10_03_2024_19_55_15', 'Murder on the Web: Catfish Gone Wrong! | Mystery & Makeup | Bailey Sarian.wav')
...
with open(os.path.join('data', 'processed', 'test', 'analysis.json'), 'r') as f:
